...
#pam configs
#alterConfigs(["/etc/login.defs"],[],[["FAILLOG_ENAB yes","LOG_UNKFAIL_ENAB yes","SYSLOG_SU_ENAB yes","SYSLOG_SG_ENAB yes","PASS_MAX_DAYS 90","PASS_MIN_DAYS 10","PASS_WARN_AGE 7"]])
